...
export class OAuthService {
  ...
  */
  ...
  getOAuthGrantRequest(sourceOrDest: 'source' | 'dest', complianceLevel: 'commercial' | 'fedramp', clientId: string,
  redirectUri: string, loginEmail: string): I_OAuthGrantRequest {
